...
workflow LongerRNAqc {
    ...
    output {
        File rnaseqc_gene_reads_gct = LongerRNAqcTask.rnaseqc_gene_reads_gct
        File rnaseqc_gene_fragments_gct = LongerRNAqcTask.rnaseqc_gene_fragments_gct
        File rnaseqc_gene_tpm_gct = LongerRNAqcTask.rnaseqc_gene_tpm_gct
        File rnaseqc_exon_reads_gct = LongerRNAqcTask.rnaseqc_exon_reads_gct
        File rnaseqc_exon_cv_tsv = LongerRNAqcTask.rnaseqc_exon_cv_tsv
        File rnaseqc_metrics_tsv = LongerRNAqcTask.rnaseqc_metrics_tsv
    }
}
